...
export default function Footer({ onOpenContact }) {
  ...
  return (
    <footer className="relative bg-[#07213A] text-white font-sans overflow-hidden">
      
      {/* 1. PRE-FOOTER CONVERSION STRIP (Vibrant Tech Orange Banner - #FA782B) */}
      <div className="bg-[#FA782B] text-white py-12 lg:py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 pb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center space-x-2">
              <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#FA782B] text-white">
              ...
              <span className="w-2 h-2 rounded-full bg-[#FA782B] inline-block animate-pulse"></span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-300">
              <li><a href="#home" className="hover:text-[#FA782B] transition-colors">Home</a></li>
              <li><a href="#who-we-are" className="hover:text-[#FA782B] transition-colors">Who We Are</a></li>
              <li><a href="#capabilities" className="hover:text-[#FA782B] transition-colors">Capabilities</a></li>
              <li><a href="#our-work" className="hover:text-[#FA782B] transition-colors">Proof of Work</a></li>
              <li><a href="#services" className="hover:text-[#FA782B] transition-colors">Engineering Process</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-300">
              <li><a href="#services" className="hover:text-[#FA782B] transition-colors">Full-Stack Web Platforms</a></li>
              <li><a href="#services" className="hover:text-[#FA782B] transition-colors">Cloud & API Architecture</a></li>
              <li><a href="#services" className="hover:text-[#FA782B] transition-colors">Workflow Automation</a></li>
              <li><a href="#services" className="hover:text-[#FA782B] transition-colors">Dedicated Engineering</a></li>
              <li><a href="#services" className="hover:text-[#FA782B] transition-colors">Performance Optimization</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-300">
              <li><a href="#our-work" className="hover:text-[#FA782B] transition-colors">Enterprise Logistics</a></li>
              <li><a href="#our-work" className="hover:text-[#FA782B] transition-colors">Decision Intelligence</a></li>
              <li><a href="#our-work" className="hover:text-[#FA782B] transition-colors">B2B SaaS Platforms</a></li>
              <li><a href="#our-work" className="hover:text-[#FA782B] transition-colors">Internal Operations</a></li>
              <li><a href="#our-work" className="hover:text-[#FA782B] transition-colors">HIPAA & FinTech Security</a></li>
            </ul>
          </div>
        ...
        <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 my-8">
          <div>
            <h4 className="text-base font-bold text-white flex items-center gap-2">
              <Mail className="w-4 h-4 text-[#FA782B]" />
          ...
          <form onSubmit={handleSubscribe} className="flex items-center w-full md:w-auto gap-2">
            {subscribed ? (
              <div className="flex items-center gap-2 text-xs font-semibold text-emerald-400 bg-emerald-950/80 px-4 py-2.5 rounded-lg border border-emerald-800">
              ...
              <>
                <input
                  ...
                  required
                  className="bg-slate-950 border border-slate-700/80 text-white placeholder-slate-500 text-xs sm:text-sm rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#FA782B] w-full sm:w-64"
                />
                <button
                  type="submit"
                  disabled={submitting}
                  className="bg-[#FA782B] hover:bg-[#e6671d] disabled:opacity-60 text-white text-xs sm:text-sm font-semibold px-5 py-2.5 rounded-lg transition-colors shrink-0 flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  {submitting ? (
                    <>
