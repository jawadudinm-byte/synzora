        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 pb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center space-x-3">
              <div className="flex items-center justify-center w-9 h-9 rounded-xl overflow-hidden shadow-lg border border-slate-700/80 bg-[#07182C]">
                <img src="/favicon.svg" alt="Synzora Emblem" className="w-full h-full object-contain p-0.5" />
              </div>
              <span className="text-2xl font-extrabold text-white tracking-wider font-brand">SYNZORA</span>
              <span className="w-2 h-2 rounded-full bg-cyan-400 inline-block animate-pulse shadow-[0_0_8px_#38bdf8]"></span>
            </div>
